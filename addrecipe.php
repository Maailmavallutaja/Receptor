...
<?php //post recipe
    ...
    if(!empty($_POST)){ // if fields are not empty
        ...
        if(!empty($_POST['optAddOns'])) { $optAddOns = $_POST['optAddOns'];}
     ...
     //   $image_name = addslashes($_FILES['upload_img']['name']);  
        ...
        $recipe = $db->prepare('
        INSERT INTO recipes (recipeName, prepTime, cookTime, instructions, ingredients, optAddOns, image, image_name)
        VALUES (:recipeName, :prepTime, :cookTime, :instructions, :ingredients, :optAddOns, :image, :image_name)
        ');
...
>>>>>>> afade0391929ef4f8d4bcee9e23369673100ccae
</html>